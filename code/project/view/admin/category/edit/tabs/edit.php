...
<br>
    ...
    <tr>
        <td><input class="btn btn-<?php echo $message ?>" type="button" onclick="mage.manageAction(this,'<?php echo $this->getUrl()->getUrl('save', 'category') ?>').load()" value="<?php echo $value ?>"></td>
    </tr>
