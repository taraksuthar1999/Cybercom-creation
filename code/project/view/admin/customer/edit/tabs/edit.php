    ...
    <div class="row">
        <div class="col-md">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <input type="button" name="btnSubmit" onclick="mage.manageAction(this,'<?php echo $this->getUrl()->getUrl('save', 'customer') ?>').load()" class="btn btn-<?php echo $message ?> bt" value="<?php echo $value ?> customer" />
            </div>
        </div>
