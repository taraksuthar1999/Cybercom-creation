...
<br>
<a class="btn btn-primary" href="<?php echo $this->getUrl()->getUrl('edit', 'Shippingmethod', null, true) ?>">Add Customer</a><br>
...
<td> <a class="btn btn-warning" href="<?php echo $this->getUrl()->getUrl('edit', 'Shippingmethod', ['id' => $value->id]); ?> "
                    <i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>&nbsp
                    <a class="btn btn-danger" href="<?php echo $this->getUrl()->getUrl('delete', 'Shippingmethod', ['id' => $value->id]); ?>">
