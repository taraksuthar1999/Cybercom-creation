...
<br>
<a class="btn btn-primary bt" href="<?php echo $this->getUrl()->getUrl('edit', 'customer', null, true) ?>">Add Customer</a><br>
...
<td> <a class="btn btn-warning bt" style="color:white" href="<?php echo $this->getUrl()->getUrl('edit', 'customer', ['id' => $value->id]); ?> ">
<i class="fas fa-pencil-alt"></i>Edit</a>&nbsp
                    <a class="btn btn-danger bt" href="<?php echo $this->getUrl()->getUrl('delete', 'customer', ['id' => $value->id]); ?>">
