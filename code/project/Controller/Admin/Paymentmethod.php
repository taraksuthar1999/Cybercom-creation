...
class Paymentmethod extends \Controller\Core\Admin
{
    ...
    public function gridAction()
    {
        try {
            ...
            $layout->getChild('Content')->addChild('grid', \Mage::getBlock('Block\Admin\Paymentmethod\Grid'));
            echo $layout->toHtml();
        } catch (Exception $e) {
    ...
    public function editAction()
    {
        ...
        try {
           ...
           // $layout->setTemplate('view/layout/twoColumnStructure.php');
            $layout->getChild('Content')->addChild('form', \Mage::getBlock('Block\Admin\Paymentmethod\Form'));
            echo $layout->toHtml();
